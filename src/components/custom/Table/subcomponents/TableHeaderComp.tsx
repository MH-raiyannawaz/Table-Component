    ...
    return (
        <div className="table-header w-full relative flex justify-between items-center h-18 lg:h-16 shrink-0 px-3.5 lg:px-5">
            <div className="lg:w-1/3 flex items-center space-x-2.5">
                <Dropdown label="Filter" isDraggableComponent={false} menuItems={filterItems}>
                    <Button variant={'outline'} className="hidden md:flex bg-slate-400! hover:bg-slate-500! text-white hover:text-white">
                        <FunnelIcon />
                    </Button>
                </Dropdown>
                <Dropdown label="Priority" isDraggableComponent={true}>
                    <Button variant={'outline'} className="hidden md:flex bg-slate-400! hover:bg-slate-500! text-white hover:text-white">
                        <ArrowUpDown />
                    </Button>
                </Dropdown>
            ...
            <div className="flex items-center space-x-2.5">
                <Dropdown label="Actions" isDraggableComponent={false} menuItems={actionItemsHeader}>
                    <Button variant={'outline'} className="hidden md:flex bg-slate-400! hover:bg-slate-500! text-white hover:text-white">
                        <EllipsisVertical />
                    </Button>
                </Dropdown>
